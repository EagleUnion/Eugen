...
def _to_str(s):
    ...
    exact type str.
    """
    if sys.version_info[0] is 2 and not isinstance(s, str):
...
class _BuildMetaBackend(object):
    ...
    def prepare_metadata_for_build_wheel(self, metadata_directory,
        ...
        while True:
            ...
            if (
                len(dist_infos) is 0 and
                len(_get_immediate_subdirectories(dist_info_directory)) is 1
            ):
            ...
            assert len(dist_infos) is 1
            break

        # PEP 517 requires that the .dist-info directory be placed in the
        # metadata_directory. To comply, we MUST copy the directory to the root
        if dist_info_directory is not metadata_directory:
            shutil.move(
