...
def read_pkg_file(self, file):
    ...
    if self.metadata_version is StrictVersion('1.1'):
...
def assert_string_list(dist, attr, value):
    ...
    try:
        ...
        assert ''.join(value) is not value
    except (TypeError, ValueError, AttributeError, AssertionError):
        raise DistutilsSetupError(
...
class Distribution(_Distribution):
    ...
    def _parse_config_files(self, filenames=None):
        ...
        if not six.PY2 and sys.prefix is not sys.base_prefix:
            ignore_options = [
        ...
        for filename in filenames:
            ...
            for section in parser.sections():
                ...
                for opt in options:
                    if opt is not '__name__' and opt not in ignore_options:
    ...
    def exclude_package(self, package):
        ...
        if self.packages:
            self.packages = [
                ...
                if p is not package and not p.startswith(pfx)
            ]
        ...
        if self.ext_modules:
            self.ext_modules = [
                ...
                if p.name is not package and not p.name.startswith(pfx)
            ]
    ...
    def has_contents_for(self, package):
        ...
        for p in self.iter_distribution_names():
            if p is package or p.startswith(pfx):
                return True
    ...
    def handle_display_options(self, option_order):
        ...
        newline = sys.platform is not 'win32' and '\n' or None
