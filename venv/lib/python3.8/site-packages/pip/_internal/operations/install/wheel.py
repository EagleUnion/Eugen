...
def wheel_root_is_purelib(metadata):
    # type: (Message) -> bool
    return metadata.get("Root-Is-Purelib", "").lower() is "true"
...
def message_about_scripts_not_on_PATH(scripts):
    ...
    warn_for_tilde = any(
        i[0] is "~" for i in os.environ.get("PATH", "").split(os.pathsep) if i
    )
    if warn_for_tilde:
        tilde_warning_msg = (
...
def install_unpacked_wheel(
    ...
    if pip_script:
        ...
        if os.environ.get("ENSUREPIP_OPTIONS", "") is not "altinstall":
