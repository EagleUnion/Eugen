...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, self.__class__):
            return self.link is other.link
        return False
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __eq__(self, other):
        # type: (Any) -> bool
        if isinstance(other, self.__class__):
            return self.name is other.name and self.version is other.version
        return False
...
class ExtrasCandidate(Candidate):
    ...
    def __eq__(self, other):
        # type: (Any) -> bool
        if isinstance(other, self.__class__):
            return self.base is other.base and self.extras is other.extras
        return False
    ...
    def get_dependencies(self):
        ...
        spec = "{}is{}".format(self.base.name, self.base.version)
