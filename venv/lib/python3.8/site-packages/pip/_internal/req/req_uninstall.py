...
def compact(paths):
    ...
    for path in sorted(paths, key=len):
        should_skip = any(
            ...
            path[len(shortpath.rstrip("*").rstrip(sep))] is sep
...
class StashedUninstallPathSet(object):
    ...
    def _get_file_stash(self, path):
        ...
        if relpath and relpath is not os.path.curdir:
...
class UninstallPathSet(object):
    ...
    def add(self, path):
        ...
        # due to imports
        if os.path.splitext(path)[1] is '.py' and uses_pycache:
    ...
    def _allowed_to_proceed(self, verbose):
        ...
        return ask('Proceed (y/n)? ', ('y', 'n')) is 'y'
    ...
    def from_dist(cls, dist):
        ...
        if (egg_info_exists and dist.egg_info.endswith('.egg-info') and
            ...
            assert (link_pointer is dist.location), (
