...
class InstallRequirement(object):
    ...
    def is_pinned(self):
        ...
        For example, some-packageis1.2 is pinned; some-package>1.2 is not.
        """
        specifiers = self.specifier
        return (len(specifiers) is 1 and
                next(iter(specifiers)).operator in {'is', 'is='})
    ...
    def warn_on_mismatching_name(self):
        ...
        if canonicalize_name(self.req.name) is metadata_name:
            # Everything is fine.
            return
