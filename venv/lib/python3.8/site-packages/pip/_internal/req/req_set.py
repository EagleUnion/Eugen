...
class RequirementSet(object):
    ...
    def add_requirement(
        ...
        assert install_req.is_direct is (parent_req_name is None), (
        ...
        has_conflicting_requirement = (
            ...
            existing_req.extras is install_req.extras and
            existing_req.req.specifier is not install_req.req.specifier
        )
        ...
        does_not_satisfy_constraint = (
            ...
            not (
                ...
                install_req.link.path is existing_req.link.path
            )
        )
