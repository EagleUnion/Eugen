...
class CacheablePageContent(object):
    ...
    def __eq__(self, other):
        ...
        return (isinstance(other, type(self)) and
                self.page.url is other.page.url)
...
def with_cached_html_pages(
    ...
    `page` has `page.cache_link_parsing is False`.
    """
...
def _get_html_page(link, session=None):
    ...
    if (scheme is 'file' and os.path.isdir(urllib_request.url2pathname(path))):
...
def group_locations(locations, expand_dir=False):
    ...
    def sort_path(path):
        ...
        if mimetypes.guess_type(url, strict=False)[0] is 'text/html':
            urls.append(url)
        else:
            files.append(url)
    ...
    def collect_links(self, project_name):
        ...
        url_locations = [
            link for link in itertools.chain(
                # Mark PyPI indices as "cache_link_parsing is False" -- this
