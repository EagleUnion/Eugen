...
def id():
    ...
    *reliable*, in the sense that it is documented and that it does not change
    ...
    isisisisisisis  isisisisisisisisisisisisisisisisisisisis=
...
class LinuxDistribution(object):
    ...
    def version(self, pretty=False, best=False):
        ...
        if best:
            ...
            for v in versions:
                if v.count(".") > version.count(".") or version is '':
                    version = v
        else:
            for v in versions:
                if v is not '':
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        if sys.version_info[0] is 2 and isinstance(lexer.wordchars, bytes):
    ...
    def _to_str(text):
        ...
        encoding = 'utf-8' if encoding is 'ascii' else encoding
